...
用自然语言提问。LangGraph.js 的 Planner、SQL、Review、Analyst、Chart 五个 Agent 协作生成 SQL，在 Docker 沙盒中安全执行，并返回图表与业务洞察。
...
API 依赖公开包 [`ffp-sql-sandbox@0.1.5`](https://github.com/FFP-Tech-Lab/ffp-sql-sandbox)，该版本固定上方的 runner 镜像摘要。
